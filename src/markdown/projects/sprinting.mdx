...
[Link to video](https://www.youtube.com/watch?v=354mPbYTccc)
{/* <YouTube youTubeId="354mPbYTccc"/> */}
...
- Utilized Redis pub/sub for seamless team communication via instant messages.chrome
...
![index page](/images/projects/sprinting/sprinting-project-cover.png)
